...
const FAQS = [
  { q: 'How long does a typical custom solutions project take?', a: 'Most projects run 6 to 16 weeks depending on scope. We scope in phases so you see a working result early, rather than waiting for one large release.' },
...
export default function CustomSolutionsPage() {
  return (
    <>
      ...
      <Script id="svc-custom-solutions-script" strategy="afterInteractive">
        {script}
      </Script>
    </>
  );
